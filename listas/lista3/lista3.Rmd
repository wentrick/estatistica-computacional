...
cat("matriz de correlação das observações")
...
```{r echo=FALSE}
par(mfrow=c(1, 2))
hist(estimate_simple_mc, main = "simples Monte Carlo")
hist(estimate_antithetic_mc, main = "antithetic variate")
# Imprimir os resultados
print(paste("Theta estimado usando o método simples de Monte Carlo:", round(theta_simple,4)))  # resultado mais longe do valor real
print(paste("Theta  estimado usando o método 'antithetic variate':", round(theta_antithetic,4)))  # resultado mais próximo do valor real
print(paste("Valor real de Theta :", round(valor_real,4)))
```
